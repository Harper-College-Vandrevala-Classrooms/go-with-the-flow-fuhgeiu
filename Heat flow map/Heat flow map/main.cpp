...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        @autoreleasepool
        {
            ...
            ImGui::SetNextWindowSize(ImVec2(500,500));                                        // set a window size, imvec2(size x, size y)
            // render new window (name, flags)
            if (ImGui::Begin("Begin",NULL,ImGuiWindowFlags_NoResize|ImGuiWindowFlags_NoCollapse)) {
